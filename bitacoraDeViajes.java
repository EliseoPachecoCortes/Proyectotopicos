 ...
 * @author elise
 */
public class bitacoraDeViajes extends javax.swing.JFrame {

    private menudeChofer menuChofer;

    public bitacoraDeViajes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        editarbitacora = new javax.swing.JButton();
        ...
        editarbitacora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/editarinformacion.png"))); // NOI18N

        jTextField8.setEditable(false);

        exportarpdf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pdf.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bitacoraDeViajes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
             new bitacoraDeViajes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton editarbitacora;
